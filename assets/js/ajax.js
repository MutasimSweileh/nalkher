  ...
  if (admin_name == "" && forr == 0 || admin_name == "" && add == 1) {
    ...
    $.ajax({
      ...
      data: {
        ...
        'radmin_name': radmin_name,
        'radmin_pass': radmin_pass,
        'forr': forr,
        'email': email
      },
  ...
  if (Gtype == "hits") {
    ...
    $.ajax({
      ...
      data: {
        ...
        'Ladf': Ladf,
        'Nadf': Nadf,
        'bloger_v_code': bloger_v_code,
        'bloger_url': bloger_url,
        'bloger_ad_count': bloger_ad_count,
        'bloger_ads': bloger_ads,
        'bloger_ad_red': bloger_ad_red,
        'bloger_ad_sand': bloger_ad_sand,
        'bloger_ad': bloger_ad,
        'bloger_ad_code': bloger_ad_code,
        'day': day,
        'allow_day': allow_day,
        'block_day': block_day,
        'ip': ip,
...
$('select[name=cantry]').change(function() {
  ...
  //error_msg(str);
  if (str == selected) {
    $('select[name=cantry] option:selected').css({
      'color': '#4caf50',
      'font-weight': 'bold'
    });
